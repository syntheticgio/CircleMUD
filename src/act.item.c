...
ACMD(do_get)
{
    ...
    // Logic for getting things - can be fleshed out here
    if (!*arg1)
        ...
        if (cont_dotmode == FIND_INDIV) {
            ...
            // TODO: Basically should be able to use for skinning, once there is a skinning flag set in a mob
            // When a mob dies does its corpse (a container) have a special property to say it is a corpse?
