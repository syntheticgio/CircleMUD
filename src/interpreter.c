...
cpp_extern const struct command_info cmd_info[] = {
  ...
  { "appraise" , "app"     , POS_STANDING, do_not_here , 0, 0 },
  ...
  { "health"   , "hea"     , POS_DEAD    , do_health_mana, 0, 0 },
  ...
  { "mana"     , "man"     , POS_DEAD    , do_health_mana, 0, 0 },
  ...
  { "stats"    , "stats"   , POS_DEAD    , do_stat     , 0, TARGET_SELF },
  ...
  { "wealth"   , "weal"    , POS_RESTING , do_gold     , 0, 0 },
